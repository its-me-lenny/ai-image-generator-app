...
const CreatePost = () => {
    ...
    if (form.prompt) {
      try {
        ...
        const response = await fetch(
          "https://dall-e-m83g.onrender.com/api/v1/dalle",
          {
            method: "POST",
            headers: {
  ...
  const handleSubmit = async (event) => {
    ...
    if (form.prompt && form.photo) {
      ...
      try {
        const response = await fetch(
          "https://dall-e-m83g.onrender.com/api/v1/post",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text=[#666e75] text-[14px] max-w-[500px]">
          Create imaginitive and visually stunning images through DALL-E Ai and
